...
async def do_confirm_instance_action(
    ...
    if matched:
        ...
        return True, f"实例 {instance_name} 已收到动作反馈：{latest_action}。"
    ...
    return False, f"动作已提交，但在 {timeout} 秒内未收到实例 {instance_name} 的状态变化消息。"
